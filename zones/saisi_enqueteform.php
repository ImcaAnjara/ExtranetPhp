                                 ...
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td> <input name="101" type="radio" class="with-gap" id="radio100"></td>
                                            <td> <input name="101" type="radio" class="with-gap" id="radio101"></td>
                                            <td> <input name="101" type="radio" class="with-gap" id="radio102"></td>
                                            <td> <input name="101" type="radio" class="with-gap" id="radio103"></td>
                                            <td> <input name="101" type="radio" class="with-gap" id="radio104"></td>
                                          </tr>
                                          <tr>
                                            <td>Consignes administratives</td>
                                            <td> <input name="102" type="radio" class="with-gap" id="radio105"></td>
                                            <td> <input name="102" type="radio" class="with-gap" id="radio106"></td>
                                            <td> <input name="102" type="radio" class="with-gap" id="radio107"></td>
                                            <td> <input name="102" type="radio" class="with-gap" id="radio108"></td>
                                            <td> <input name="102" type="radio" class="with-gap" id="radio109"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                                 ...
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td> <input name="107" type="radio" class="with-gap" id="radio130"></td>
                                            <td> <input name="107" type="radio" class="with-gap" id="radio131"></td>
                                            <td> <input name="107" type="radio" class="with-gap" id="radio132"></td>
                                            <td> <input name="107" type="radio" class="with-gap" id="radio133"></td>
                                            <td> <input name="107" type="radio" class="with-gap" id="radio134"></td>
                                          </tr>
                                          <tr>
                                            <td>Locaux</td>
                                            <td> <input name="108" type="radio" class="with-gap" id="radio135"></td>
                                            <td> <input name="108" type="radio" class="with-gap" id="radio136"></td>
                                            <td> <input name="108" type="radio" class="with-gap" id="radio137"></td>
                                            <td> <input name="108" type="radio" class="with-gap" id="radio138"></td>
                                            <td> <input name="108" type="radio" class="with-gap" id="radio139"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                                 ...
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td> <input name="109" type="radio" class="with-gap" id="radio140"></td>
                                            <td> <input name="109" type="radio" class="with-gap" id="radio141"></td>
                                            <td> <input name="109" type="radio" class="with-gap" id="radio142"></td>
                                            <td> <input name="109" type="radio" class="with-gap" id="radio143"></td>
                                            <td> <input name="109" type="radio" class="with-gap" id="radio144"></td>
                                          </tr>
                                          <tr>
                                            <td>Variété et qualité des activités</td>
                                            <td> <input name="110" type="radio" class="with-gap" id="radio145"></td>
                                            <td> <input name="110" type="radio" class="with-gap" id="radio146"></td>
                                            <td> <input name="110" type="radio" class="with-gap" id="radio147"></td>
                                            <td> <input name="110" type="radio" class="with-gap" id="radio148"></td>
                                            <td> <input name="110" type="radio" class="with-gap" id="radio149"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                                 ...
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td> <input name="111" type="radio" class="with-gap" id="radio150"></td>
                                            <td> <input name="111" type="radio" class="with-gap" id="radio151"></td>
                                            <td> <input name="111" type="radio" class="with-gap" id="radio152"></td>
                                            <td> <input name="111" type="radio" class="with-gap" id="radio153"></td>
                                            <td> <input name="111" type="radio" class="with-gap" id="radio154"></td>
                                          </tr>
                                          <tr>
                                            <td>Qualité du contenu (Livre et cahier d'exercices)</td>
                                            <td> <input name="112" type="radio" class="with-gap" id="radio155"></td>
                                            <td> <input name="112" type="radio" class="with-gap" id="radio156"></td>
                                            <td> <input name="112" type="radio" class="with-gap" id="radio157"></td>
                                            <td> <input name="112" type="radio" class="with-gap" id="radio158"></td>
                                            <td> <input name="112" type="radio" class="with-gap" id="radio159"></td>
                                          </tr>
                                          <tr>
                                            <td>Audio/Vidéo</td>
                                            <td> <input name="113" type="radio" class="with-gap" id="radio160"></td>
                                            <td> <input name="113" type="radio" class="with-gap" id="radio161"></td>
                                            <td> <input name="113" type="radio" class="with-gap" id="radio162"></td>
                                            <td> <input name="113" type="radio" class="with-gap" id="radio163"></td>
                                            <td> <input name="113" type="radio" class="with-gap" id="radio164"></td>
                                          </tr>
                                          <tr>
                                            <td>Plateforme E-learning</td>
                                            <td> <input name="114" type="radio" class="with-gap" id="radio165"></td>
                                            <td> <input name="114" type="radio" class="with-gap" id="radio166"></td>
                                            <td> <input name="114" type="radio" class="with-gap" id="radio167"></td>
                                            <td> <input name="114" type="radio" class="with-gap" id="radio168"></td>
                                            <td> <input name="114" type="radio" class="with-gap" id="radio169"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                                 ...
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td> <input name="115" type="radio" class="with-gap" id="radio170"></td>
                                            <td> <input name="115" type="radio" class="with-gap" id="radio171"></td>
                                            <td> <input name="115" type="radio" class="with-gap" id="radio172"></td>
                                            <td> <input name="115" type="radio" class="with-gap" id="radio173"></td>
                                            <td> <input name="115" type="radio" class="with-gap" id="radio174"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                          	...
                          	<div class="table-responsive">
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td>Animation</td>
                                            <td> <input name="116" type="radio" class="with-gap" id="radio175"></td>
                                            <td> <input name="116" type="radio" class="with-gap" id="radio176"></td>
                                            <td> <input name="116" type="radio" class="with-gap" id="radio177"></td>
                                            <td> <input name="116" type="radio" class="with-gap" id="radio178"></td>
                                            <td> <input name="116" type="radio" class="with-gap" id="radio179"></td>
                                          </tr>
                                          <tr>
                                            <td>Choix des exercices</td>
                                            <td> <input name="117" type="radio" class="with-gap" id="radio180"></td>
                                            <td> <input name="117" type="radio" class="with-gap" id="radio181"></td>
                                            <td> <input name="117" type="radio" class="with-gap" id="radio182"></td>
                                            <td> <input name="117" type="radio" class="with-gap" id="radio183"></td>
                                            <td> <input name="117" type="radio" class="with-gap" id="radio184"></td>
                                          </tr>
                                          <tr>
                                            <td>Pédagogie</td>
                                            <td> <input name="118" type="radio" class="with-gap" id="radio185"></td>
                                            <td> <input name="118" type="radio" class="with-gap" id="radio186"></td>
                                            <td> <input name="118" type="radio" class="with-gap" id="radio187"></td>
                                            <td> <input name="118" type="radio" class="with-gap" id="radio188"></td>
                                            <td> <input name="118" type="radio" class="with-gap" id="radio189"></td>
                                          </tr>
                                          <tr>
                                            <td>Ponctualité</td>
                                            <td> <input name="119" type="radio" class="with-gap" id="radio190"></td>
                                            <td> <input name="119" type="radio" class="with-gap" id="radio191"></td>
                                            <td> <input name="119" type="radio" class="with-gap" id="radio192"></td>
                                            <td> <input name="119" type="radio" class="with-gap" id="radio193"></td>
                                            <td> <input name="119" type="radio" class="with-gap" id="radio194"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                          	...
                          	<div class="table-responsive">
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td>Animation</td>
                                            <td> <input name="120" type="radio" class="with-gap" id="radio195"></td>
                                            <td> <input name="120" type="radio" class="with-gap" id="radio196"></td>
                                            <td> <input name="120" type="radio" class="with-gap" id="radio197"></td>
                                            <td> <input name="120" type="radio" class="with-gap" id="radio198"></td>
                                            <td> <input name="120" type="radio" class="with-gap" id="radio199"></td>
                                          </tr>
                                          <tr>
                                            <td>Choix des exercices</td>
                                            <td> <input name="121" type="radio" class="with-gap" id="radio200"></td>
                                            <td> <input name="121" type="radio" class="with-gap" id="radio201"></td>
                                            <td> <input name="121" type="radio" class="with-gap" id="radio202"></td>
                                            <td> <input name="121" type="radio" class="with-gap" id="radio203"></td>
                                            <td> <input name="121" type="radio" class="with-gap" id="radio204"></td>
                                          </tr>
                                          <tr>
                                            <td>Pédagogie</td>
                                            <td> <input name="122" type="radio" class="with-gap" id="radio205"></td>
                                            <td> <input name="122" type="radio" class="with-gap" id="radio206"></td>
                                            <td> <input name="122" type="radio" class="with-gap" id="radio207"></td>
                                            <td> <input name="122" type="radio" class="with-gap" id="radio208"></td>
                                            <td> <input name="122" type="radio" class="with-gap" id="radio209"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
                          	...
                          	<div class="table-responsive">
                                 <table class="table table-hover">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td>Globalement</td>
                                            <td> <input name="123" type="radio" class="with-gap" id="radio210"></td>
                                            <td> <input name="123" type="radio" class="with-gap" id="radio211"></td>
                                            <td> <input name="123" type="radio" class="with-gap" id="radio212"></td>
                                            <td> <input name="123" type="radio" class="with-gap" id="radio213"></td>
                                            <td> <input name="123" type="radio" class="with-gap" id="radio214"></td>
                                          </tr>
                                        </tbody>
                                      </table>
                         	 </div>
